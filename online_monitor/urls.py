...
urlpatterns = [
    ...
    url(r'^run_monitor', login_required(TemplateView.as_view(template_name="online_monitor/run_monitor.html"))),
    url(r'^get_modes_in_range', views.get_modes_in_range, name='get_modes_in_range'),
    url(r'^select_runs', views.select_runs ,name='select_runs'),
    url(r'^get_plot_xy', views.get_plot_xy, name='get_plot_xy'),
